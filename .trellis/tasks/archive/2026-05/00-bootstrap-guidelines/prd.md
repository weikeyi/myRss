...
- [x] Fill guidelines for @myrss/config
- [x] Fill guidelines for @myrss/core
- [x] Fill guidelines for db
- [x] Fill guidelines for @myrss/shared
- [x] Add code examples
...
### Package: @myrss/shared (`spec/shared/`)
